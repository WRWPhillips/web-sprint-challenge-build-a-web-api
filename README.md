...
1. The core features of Node.js and Express and why they are useful.
  Node.js allows you to manage a backend using only JavaScript, which is useful because a frontend is also written in JavaScript. Express streamlines the process of running an API and allows you to create a server and write routes and API endpoints.
1. Understand and explain the use of Middleware.
  Middleware is reusable code that intercepts ongoing processes and either validates or performs other operations on those processes. It can either stop processes, mutate and pass them forward, or just pass them forward. Middleware allows you to make more DRY code, and promotes separation of concerns for debugging. 
1. The basic principles of the REST architectural style.
  REST allows for clean, stateless, standardized and cachable information transfer between client and server. It means that the exchange of information is not messy and is done in a standard way. This means with a standard protocol the code base of either client or server is irrelevant, I think the word is language agnostic. It allows for separation of concerns and makes things way way cleaner.
1. Understand and explain the use of Express Routers.
  Express Routers allow you to create specialized functions for different url routes on your server to return different information from different places, this also allows for separation of concerns.
1. Describe tooling used to manually test the correctness of an API.
  Programs like Postman and HTTPie allow you to submit HTTP requests to an API in order to test different endpoints, and are invaluable for testing. 
